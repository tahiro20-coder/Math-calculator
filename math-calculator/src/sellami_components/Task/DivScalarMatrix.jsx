...
const Description = `
  the Calculator will dividing a matrix with by scalar item by item where the result and 
  the input matrix will be the same size
`

const DivScalarMatrix = () => {
  ...
  const handleSubmit = () =>{
    StandardFAPIService.DivScalarMatrix({matrix1,scalar})
...
export default DivScalarMatrix